...
VALUES
    ...
    (gen_random_uuid(), (SELECT id FROM com_example_store_dayz.info_group WHERE name = 'Люди Бармена'), 'Руководство Бармена', 'Бармен играет ключевую роль в группе, координируя её действия и обеспечивая безопасность и выживание своих людей.')
